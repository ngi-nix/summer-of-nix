...
Although the general idea was thus clear, we didn't know precisely how many applicants to expect for this program and how to put it in practise. Initially we thought we would maybe find 10-15 participants. Without any additional data, we took final decision on the compensation, the time frame from August 2nd to October 15th, and also the mentor role.

<!-- compensation -->

Compensation was fixed to a flat base rate of 2750 Euro per participant within the EU (as a gesture to the European Union who ultimately funded this project), and otherwise adjusted for purchasing power based on a list from Google's Summer of Code (in lack of a better source). Worldwide equal pay was considered as well, arguments for and against came up, but ultimately we decided to adjust because it was also recommended by the European Commission. It is still unclear to me whether this was/is a fairer choice or not. Certainly, participants from EU countries with generally lower income a good deal but that seemed fair on other grounds. Payments themselves to all corners of the world were to be handled by the NixOS Foundation and NLNet, more experienced with this type of situation.

<!-- time frame -->

The time frame from August 2nd to October 15th was also not easy to decide. We wanted to get university breaks across a variety of countries but didn't really have the data to take a better choice at this moment. We designed the program for 8 weeks, a bit similar to Google Summer of Code, so that actual work could be accomplished. We expected to see more tangible outcome in the form of packages and other code contributions the second half of the program. 

## Announcement and interviews

<!-- announcement -->

These basic decisions were enough to announce the program on the NixOS discourse [@sonannouncement] and see who would apply. We didn't want to design a program before knowing who would actually participate. The response to this announcement was overwhelming and much more than the 10-15 participants we expected. We got 94 participant applications and in addition about 10 from developers willing to mentor. Applications were handled over email only, another general rule that we tried to follow was to avoid sign ups and reduce the barrier to participation as much as possible. Also email seemed more personal, especially when expecting only 20 applications anyway.

<!-- interviews -->

In the application email, we asked a few simple questions to the applicants: Who are you? Why are you interested in this program? What are you able to do with in Nix? What would you like to learn? When are you available? What time zone? Specific requirements? Optional CV. These questions turned out to be very useful to quickly assess someone. But in addition we also decided to have short 15-30min interviews with every applicant without exception. We thus did over 100 interviews in a months with a little team of 4 volunteers who were doing this besides their work. Again, in hindsight this was maybe not worth it and really exhausted us in the end, but it also gave the program a very personal, respectful and warm touch, and as interviewers we got a much better feeling for the Nix community, the wishes and goals of the applying participants, and therefore ultimately the program that we were going to run. During these interviews it became clear that we had a lot of enthusiastic, extremely nice and knowledgeable people applying, many of them knowing a lot more about Nix than I do myself.

## Selection process and team building

<!-- why we needed to select -->

While the sheer amount and the high quality of the application was extremely motivation and made us want to turn forward time to get started with the program, it also brought us in the unpleasant situation of having to select and pick one good person over another—something we had hoped wouldn't happen anyway.

<!-- selection through team building -->

Ultimately we had a limited number seats in the program, and we also wanted to have those seats organized in small teams to provide the support structure that was formerly missing. We decided to go with 5 developers plus 1 mentor as basic team structure, and the team requirements guided the selection process a bit:

<!-- diversity -->

Since the program was specifically _not_ about just delivering code as quick as possible, but also about learning together and meeting other like-minded people, we didn't want to simply select the “best Nixer” in whatever subjective definition and fill up the teams. In contrast, team **diversity** seemed to be highly desirable to actually make a fun program in the work-learn-meet spirit outlined above, naturally generating opportunities to learn from and have interesting conversations with each other.

<!-- geographical diversity -->

Unfortunately team diversity in all aspects isn't easily achievable: A first decision that we felt forced to take was to have timezone-homogeneous teams that weren't too regionally diverse (spread ±3 hours). Meetings and synchronous communication with more than 3 people spread over America, Europe and Asia, which we thought was _the_ essential part of the team idea, just seemed to hard to organize otherwise. We thus focused to favor geographical diversity across teams, and basically had 15 spots (3 teams) for Central European time zones, 10 spots (2 teams) for American time zones and 5 spots (1 team) for East European, Middle East and 5 spots (1 team) Far Eastern Asian time zones. Besides the fact that we wanted to slightly favour European time zones because the funding came from there, the choice of numbers was imposed by applications because by far most of them came from Europe, paradoxically still giving a higher chance to non-Europeans to participate although there were less overall slots for them.

<!-- gender -->

Another failure was to achieve gender diversity. Unfortunately, the only two (but very strong) female applications weren't enough to even consider forming somewhat diverse teams.

<!--how we built the teams in the end -->

All this meant that we were left with building teams from the different regions that were diverse along the axes of **seniority** and **nix skill**. We did this in a way which I'll call, for the lack of a better term, compartmentalized randomness, building on a 3x3 matrix of seniority and nix skill a random queue of applicants. The process was certainly not objective as basically any application process, but I think we were guided by reasonable principles. It meant in the end that senior Nix experts did have the highest chance to participate, simply because there weren't as many of them but it also gave a fair chance to others.

<!-- other possibilities -->

We maybe could have considered additional axes to build the teams. For example, grouping people who were interested in similar technology, but this seemed to become too complicated under the regional constraints and also a bit premature because we didn't go through the actual work yet in detail and hadn't thought about how to actually distribute it among the teams.

<!-- result -->

With this process, we have built seven teams of five, meaning that we would have 35 participants and 7 mentors. In addition we reserved one extra mentor for additional tasks which would become clear later. This also determined the overall budget that we would need, which was higher than originally anticipated but which felt like a good investment since the application quality was so high.
